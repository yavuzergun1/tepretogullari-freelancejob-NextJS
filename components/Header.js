...
const Header = () => {
  ...
  return (
    <Navbar
      fluid={true}
      rounded={true}
      className="border-black-500 border-b-2  px-4 lg:px-9 py-2"
    >
      <Navbar.Brand>
        <div
      ...
      <Navbar.Collapse>
        <Navbar.Link
          className="hover:text-[rgb(71,101,236)]"
          href={"/hakkimizda"}
        >
          Hakkımızda
        </Navbar.Link>
        <Navbar.Link className="hover:text-[rgb(71,101,236)]" href={"/tarihce"}>
          {" "}
          Tarihçemiz
        </Navbar.Link>
        <Navbar.Link
